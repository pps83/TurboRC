...
#define mbcenc(rcrange,rclow,rcilow, _cx_, _cxbits_, _m_,_prm0_,_prm1_,_op_, _x_) {\
  ...
  { mbu *_m = &_mh[(_cxh >> 2) & 0x3c | 3]; mbu_enc(rcrange,rclow,rcilow, _m,_prm0_,_prm1_,_op_, RCB(_cxh,3)); }\
  { mbu *_m = &_mh[(_cxh >> 1) & 0x3c | 2]; mbu_enc(rcrange,rclow,rcilow, _m,_prm0_,_prm1_,_op_, RCB(_cxh,2)); }\
  { mbu *_m = &_mh[(_cxh     ) & 0x3c | 1]; mbu_enc(rcrange,rclow,rcilow, _m,_prm0_,_prm1_,_op_, RCB(_cxh,1)); }\
  { mbu *_m = &_mh[(_cxh << 1) & 0x3c    ]; mbu_enc(rcrange,rclow,rcilow, _m,_prm0_,_prm1_,_op_, RCB(_cxh,0)); }\
  ...
  { mbu *_m = &_ml[(_cxl >> 2) & 0x3c | 3]; mbu_enc(rcrange,rclow,rcilow, _m,_prm0_,_prm1_,_op_, RCB(_cxl,3)); }\
  { mbu *_m = &_ml[(_cxl >> 1) & 0x3c | 2]; mbu_enc(rcrange,rclow,rcilow, _m,_prm0_,_prm1_,_op_, RCB(_cxl,2)); }\
  { mbu *_m = &_ml[(_cxl     ) & 0x3c | 1]; mbu_enc(rcrange,rclow,rcilow, _m,_prm0_,_prm1_,_op_, RCB(_cxl,1)); }\
